  ...
  try {
    ...
    const reviews = [
      ...
      },
      {
        ...
        orderAmount: 160,
        orderQuantity: 1,
        comment: 'Paneer Butter Masala was rich and creamy. Delivery was slightly late but food quality made up for it.',
        providerReply: 'Glad you enjoyed the Punjabi combo, Neha! We are streamlining delivery routes to be faster.',
      ...
      },
      {
        ...
        customerPhone: '+91 98240 77665',
        customerTotalOrders: 24,
        customerTotalReviews: 7,
        tiffinId: insertedTiffins[0]._id.toString(),
        tiffinName: 'Gujarati Special Kathiyawadi Thali',
        tiffinCategory: 'Gujarati',
        rating: 5,
      ...
      },
      {
        ...
        customerEmail: 'chirag.desai@gmail.com',
        customerPhone: '+91 98255 66778',
        customerTotalOrders: 30,
        customerTotalReviews: 6,
        tiffinId: insertedTiffins[3]._id.toString(),
        tiffinName: 'Healthy Low-Cal High Protein Thali',
        tiffinCategory: 'Healthy',
        rating: 5,
        ...
        orderAmount: 300,
        orderQuantity: 2,
        comment: 'Excellent high protein option for gym goers. Sprouts were fresh and paneer was tender.',
        providerReply: 'Thank you Chirag! We prepare high protein meals with olive oil and organic sprouts.',
        repliedAt: new Date(now - 30 * 60 * 1000),
        repliedBy: 'Mansuri Kitchen',
      ...
      },
      {
        ...
        orderAmount: 198,
        orderQuantity: 2,
        comment: 'Great value for money mini thali. Perfect portion size for office lunch.',
        providerReply: '',
